...
import { getGlobal, subscribeToGlobal, type WidgetGlobals } from '../providers';
 ...
 */
export function useWidgetGlobal<K extends keyof WidgetGlobals>(key: K): WidgetGlobals[K] | null {
