 ...
 *
 * Uses the same approach as skybridge:
...
function getViteResourceHtml(srcPath: string): string {
  ...
  // Native ES module approach matching skybridge
  // KEY: Use localhost URL for dev (not ngrok URL) to bypass ngrok warning page
