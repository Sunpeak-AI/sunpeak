...
- **App Context** — model context JSON shared with the model via [`useUpdateModelContext()`](/app-framework/hooks/use-update-model-context), shown in the right sidebar
- **Tool Input/Result** — editable JSON for the [tool arguments and structured content](/app-framework/hooks/use-tool-data), shown in the right sidebar
