...
keywords: ["MCP Apps", "MCP Apps FAQ", "ChatGPT Apps", "ChatGPT plugins", "Claude Apps", "MCP app framework", "ui:// resource", "MCP Apps SDK", "how to build an MCP App", "MCP App iframe", "MCP App display modes"]
---
