...
<Tip>
The [sunpeak framework](/quickstart) provides React convenience hooks that wrap these methods: [`useCallServerTool`](/api-reference/hooks/use-call-server-tool), [`useDownloadFile`](/api-reference/hooks/use-download-file), [`useListServerResources`](/api-reference/hooks/use-list-server-resources), [`useReadServerResource`](/api-reference/hooks/use-read-server-resource), [`useSendMessage`](/api-reference/hooks/use-send-message), [`useUpdateModelContext`](/api-reference/hooks/use-update-model-context), [`useOpenLink`](/api-reference/hooks/use-open-link), [`useRequestDisplayMode`](/api-reference/hooks/use-request-display-mode), [`useRequestTeardown`](/api-reference/hooks/use-request-teardown), and [`useSendLog`](/api-reference/hooks/use-send-log).
</Tip>
