...
<Tip>
The [sunpeak framework](/quickstart) provides React hooks that wrap these accessors reactively: [`useHostContext`](/api-reference/hooks/use-host-context), [`useHostInfo`](/api-reference/hooks/use-host-info), [`useTheme`](/api-reference/hooks/use-theme), [`useLocale`](/api-reference/hooks/use-locale), and [`useDeviceCapabilities`](/api-reference/hooks/use-device-capabilities).
</Tip>
