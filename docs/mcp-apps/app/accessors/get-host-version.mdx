...
<Tip>
The [sunpeak framework](/quickstart) provides [`useHostInfo`](/api-reference/hooks/use-host-info) for reactive access to the host's name and version in React components.
</Tip>
