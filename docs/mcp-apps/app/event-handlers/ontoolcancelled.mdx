...
The sunpeak framework provides the [`useToolData`](/api-reference/hooks/use-tool-data) hook, which manages the full tool lifecycle including cancellation as a reactive value.
