...
The sunpeak framework provides the [`useToolData`](/api-reference/hooks/use-tool-data) hook, which wraps `ontoolresult` (along with related handlers) into a reactive value for React components.
