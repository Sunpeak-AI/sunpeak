...
- **Streamable HTTP** — Communication over HTTP with server-sent events. Used for remote servers accessible over the network. This is the transport sunpeak uses.
...
- **Prompts** — Reusable prompt templates. Not used by sunpeak.
