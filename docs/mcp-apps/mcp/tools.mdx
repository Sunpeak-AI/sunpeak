...
<Tip>
In the [sunpeak framework](/quickstart), tools are defined as individual files that are auto-discovered. See the [Tool File Reference](/api-reference/tools/tool-file).
</Tip>
