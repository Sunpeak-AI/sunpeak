...
```ts
import { useHostStyles, useHostStyleVariables, useHostFonts } from "@modelcontextprotocol/ext-apps/react";
```
...
## [useHostStyleVariables](/mcp-apps/react/use-host-style-variables)
...
## [useHostFonts](/mcp-apps/react/use-host-fonts)
