...
Set `_meta.ui` on the resource config exported from your resource file. Sunpeak passes it through to both the `resources/list` and `resources/read` responses automatically.
