...
<Tip>
The [sunpeak framework](/quickstart) provides [`useAppTools`](/app-framework/hooks/use-app-tools) for calling app-visible tools from React components, and the [Tool File Reference](/app-framework/tools/tool-file) for defining tool metadata.
</Tip>
