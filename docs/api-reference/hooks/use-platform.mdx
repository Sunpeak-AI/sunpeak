...
<Tip>This returns the host-reported platform from [`McpUiHostContext.platform`](/mcp-apps/types/core-types#mcpuihostcontext), not a runtime detection. For runtime host detection (ChatGPT vs Claude), see [`detectHost`](/api-reference/functions/host-detection).</Tip>
