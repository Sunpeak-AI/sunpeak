...
<Tip>
For browser-level detection outside of React or when host context is unavailable, sunpeak also exports [`isPrimarilyTouchDevice`](/api-reference/functions/utilities#isprimarilytouchdevice) and [`isHoverAvailable`](/api-reference/functions/utilities#ishoveravailable) utility functions.
</Tip>
