...
Each resource folder from `src/resources/{name}/` is built to `dist/{name}/`, containing the JS bundle and metadata. Simulation files are not included in the build output.
