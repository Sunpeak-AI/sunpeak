...
http://localhost:6767/?simulation=albums-show&theme=light

# Fullscreen dark mode
http://localhost:6767/?simulation=review-diff&theme=dark&displayMode=fullscreen

# Mobile simulation with touch
http://localhost:6767/?simulation=map-show&deviceType=mobile&touch=true&hover=false
```
