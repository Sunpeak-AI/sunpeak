...
- **ChatGPT account:** You need a ChatGPT account with developer-mode app support
...
Add your MCP server from the ChatGPT Plugins page:
...
4. If you are adding the app, enter your tunnel URL with the `/mcp` path (e.g., `https://abc123.ngrok.io/mcp`) and save it
