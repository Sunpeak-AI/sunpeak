...
3. **Test** your app with automated e2e tests using the simulator (`pnpm test:e2e`)
4. **Live test** against real ChatGPT with `pnpm test:live` (see [Testing Guide](/guides/testing#live-testing))
