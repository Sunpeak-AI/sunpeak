...
<Warning>
These hooks throw if called outside ChatGPT. Always feature-detect with `isChatGPT()` first. See [Host Detection](/app-framework/functions/host-detection).
</Warning>

## Dive Deeper

<Card horizontal title="Runtime API Reference" icon="code" href="/app-framework/hooks/use-app">
