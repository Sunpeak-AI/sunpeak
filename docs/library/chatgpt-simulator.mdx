...
<Tabs>
  <Tab title="Framework (JSON)">
    ...
    The resource component (`src/resources/example/example-resource.tsx`) and metadata (`src/resources/example/example-resource.json`) are automatically linked based on matching folder names.
