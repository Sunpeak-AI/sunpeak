...
Automated testing against real ChatGPT. Tests live in `tests/live/`. Run with `pnpm test:live`. See the [Testing Guide](/guides/testing#live-testing) for setup details.
