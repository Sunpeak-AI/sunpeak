...
<img
  src="https://d10djik02wlf6x.cloudfront.net/sunpeak-docs-fullscreen-dark.png"
  alt="ChatGPT Simulator set to fullscreen dark mode via URL params"
/>

<img
  src="https://d10djik02wlf6x.cloudfront.net/sunpeak-docs-inline-light.png"
  alt="ChatGPT Simulator set to inline light mode via URL params"
/>
